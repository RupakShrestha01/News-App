<template>
    <div v-if="isMenuOpen">
        <div class="bg-indigo-500 lg:w-4/5 mx-auto p-4 my-12 lg:h-28">
            <div class="mx-auto max-w-7xl py-3 px-3 sm:px-6 lg:px-8 ">
                <div class="flex flex-wrap items-center justify-between lg:mt-2">
                    <div class="flex w-0 flex-1 items-center">
                        ...
                        <p class="ml-3 truncate font-medium text-white">
                            ...
                            <span class="hidden md:inline">Big news! We're excited to announce a brand new
                                product.</span>
                        </p>
                    </div>
