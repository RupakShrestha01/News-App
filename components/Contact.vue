<template>
    ...
    <div class="container mx-auto lg:w-4/5 my-32 p-10 ">
        <div class="-mx-4 flex flex-wrap lg:justify-between">
            <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div class="mb-12 max-w-[570px] lg:mb-0">
                    <span class=" mb-4 block text-base font-semibold">
                        Contact Us
                    </span>
                    <h2
                    ...
                    <div class="mb-8 flex w-full max-w-[370px]">
                        <div
                            class="bg-indigo-500  mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                    ...
                    <form>
                        ...
                        <div class="mb-6">
                            <textarea rows="6" placeholder="Your Message"
                                class="text-black border-[f0f0f0] focus:border-primary w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"></textarea>
                        </div>
                        <div>
                            <button type="submit"
                                class="bg-indigo-500 border-black w-full rounded border p-3 text-white transition hover:bg-opacity-90">
                                Send Message
                            </button>
                        </div>
                    </form>
